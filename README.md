...
Oracle Linux 환경에서 cron으로 실행하는 OCI AutoStop 애플리케이션이다. tenancy 범위 또는 DEV 기준 subtree 범위를 조회하고, exception 파일에 기록된 compartment subtree를 제외한 뒤 Instance, Oracle Base DB Node, ADB, MySQL HeatWave DB System 중 실행 대상 상태의 리소스만 정지한다.
...
| 리소스 | 조회/정지 클라이언트 | 정지 대상 상태 | 정지 완료 판정 | 비고 |
| --- | --- | --- | --- | --- |
| Instance | `oci.core.ComputeClient` | `RUNNING` | `STOPPED` | `TERMINATED`는 무시 |
| Oracle Base DB Node | `oci.database.DatabaseClient` | `AVAILABLE` | `STOPPED` | DB System이 `TERMINATED`면 하위 Oracle Base DB Node 조회를 건너뜀 |
| ADB | `oci.database.DatabaseClient` | `AVAILABLE` | `STOPPED` 또는 `UNAVAILABLE` | `TERMINATED`는 무시 |
| MySQL HeatWave DB System | `oci.mysql.DbSystemClient` | `ACTIVE` | `INACTIVE` | `StopDbSystemDetails(shutdown_type="FAST")`로 정지 요청, `DELETED`는 무시 |
...
사용하는 OCI 주체에는 compartment/region 조회 권한과 함께 Instance, Oracle Base DB Node, ADB, MySQL HeatWave DB System을 조회하고 정지할 수 있는 권한이 필요하다. MySQL HeatWave가 추가되었으므로 기존 Compute/Database 권한만 있던 정책은 MySQL HeatWave DB System 조회 및 stop 권한까지 포함하도록 검토해야 한다.
...
- `execution.post_check_delay_seconds`
  ...
  - Oracle Base DB, ADB, MySQL HeatWave 정지 시간이 긴 환경이면 늘릴 수 있다.
- `execution.post_check_max_workers`
  - stop 후 검증 작업의 region 병렬 처리 개수
- `execution.stop_wait_timeout_seconds`
  - 설정 객체에는 포함되어 있으나 현재 서비스 로직에서는 별도 wait loop에 사용하지 않는다.
...
- `logging.summary_directory`, `logging.backup_count`
  - 설정 객체에는 포함되어 있으나 현재 로깅 구현은 `logs/autostop_daily.log` 단일 파일만 생성한다.
...
8. region별로 Instance / Oracle Base DB / ADB / MySQL HeatWave 조회
9. 상태에 따라 stop 또는 skip
10. 실제 stop 실행이면 요청된 리소스를 region별로 묶고 `execution.post_check_delay_seconds` 이후 최종 상태를 1회 재확인
11. 수행 완료 파트와 summary details 출력

## 상태 처리 기준

- Instance: `RUNNING` stop, `STOPPED` skip, `STOPPING/STARTING/PROVISIONING` transition skip, `TERMINATED` ignore
- Oracle Base DB Node: `AVAILABLE` stop, `STOPPED` skip, `STOPPING/STARTING/PROVISIONING` transition skip
- ADB: `AVAILABLE` stop, `STOPPED/UNAVAILABLE` skip, `STOPPING/STARTING/PROVISIONING/SCALING` transition skip, `TERMINATED` ignore
- MySQL HeatWave DB System: `ACTIVE` stop, `INACTIVE` skip, `CREATING/UPDATING/DELETING` transition skip, `DELETED` ignore
- 위에 명시되지 않은 기타 상태는 `Non-target state`로 보고 stop 요청 없이 skip한다.
...
[2026-04-01 18:30:00] [INFO] OCI Daily AutoStop (Instance, Oracle Base DB, ADB, MySQL HeatWave)
...
[2026-04-01 18:30:03] [INFO]   [Oracle Base DB] dbnode-01 (ap-seoul-1) -> In transition (STOPPING)
[2026-04-01 18:30:03] [INFO]   [MySQL HeatWave] mysql-01 (ap-seoul-1) -> Stop target (dry-run)
[2026-04-01 18:30:03] [INFO] ============================================================
[2026-04-01 18:30:03] [INFO] Dry-run analysis completed (1 Instance(s), 0 Oracle Base DB Node(s), 0 ADB(s), 1 MySQL HeatWave DB System(s) matched).
[2026-04-01 18:30:03] [INFO] ============================================================
[2026-04-01 18:30:03] [INFO] Summary Details
[2026-04-01 18:30:03] [INFO]  Instance(s) scanned : 12
...
[2026-04-01 18:30:03] [INFO]  Oracle Base DB Node(s) scanned : 3
[2026-04-01 18:30:03] [INFO]   ├─ Already stopped : 2
[2026-04-01 18:30:03] [INFO]   ├─ In transition   : 1
[2026-04-01 18:30:03] [INFO]   └─ Stop targets (Dry-run) : 0
[2026-04-01 18:30:03] [INFO]  ADB(s) scanned : 1
[2026-04-01 18:30:03] [INFO]   ├─ Already stopped : 1
[2026-04-01 18:30:03] [INFO]   ├─ In transition   : 0
[2026-04-01 18:30:03] [INFO]   └─ Stop targets (Dry-run) : 0
[2026-04-01 18:30:03] [INFO]  MySQL HeatWave DB System(s) scanned : 1
[2026-04-01 18:30:03] [INFO]   ├─ Already stopped : 0
[2026-04-01 18:30:03] [INFO]   ├─ In transition   : 0
[2026-04-01 18:30:03] [INFO]   └─ Stop targets (Dry-run) : 1
...
[2026-04-01 18:30:03] [INFO]   [Oracle Base DB] dbnode-01 (ap-seoul-1) -> Stop request sent
[2026-04-01 18:30:03] [INFO]   [ADB] adb-01 (ap-seoul-1) -> Stop request sent
[2026-04-01 18:30:03] [INFO]   [MySQL HeatWave] mysql-01 (ap-seoul-1) -> Stop request sent
[2026-04-01 18:30:03] [INFO] ============================================================
[2026-04-01 18:30:03] [INFO] Stop requests completed (1 Instance(s), 1 Oracle Base DB Node(s), 1 ADB(s), 1 MySQL HeatWave DB System(s)).
[2026-04-01 18:30:03] [INFO] ============================================================
...
[2026-04-01 18:31:03] [WARNING] Resource not yet fully stopped at verification time. type=oracle_base_db name=dbnode-01 region=ap-seoul-1 state=STOPPING
[2026-04-01 18:31:03] [INFO] ============================================================
[2026-04-01 18:31:03] [INFO] Summary Details
[2026-04-01 18:31:03] [INFO]  Instance(s) scanned : 12
...
[2026-04-01 18:31:03] [INFO]  Oracle Base DB Node(s) scanned : 3
[2026-04-01 18:31:03] [INFO]   ├─ Already stopped : 2
[2026-04-01 18:31:03] [INFO]   ├─ In transition   : 0
[2026-04-01 18:31:03] [INFO]   └─ Stop by AutoStop : 1 → 0 successful
[2026-04-01 18:31:03] [INFO]  ADB(s) scanned : 1
[2026-04-01 18:31:03] [INFO]   ├─ Already stopped : 0
[2026-04-01 18:31:03] [INFO]   ├─ In transition   : 0
[2026-04-01 18:31:03] [INFO]   └─ Stop by AutoStop : 1 → 1 successful
[2026-04-01 18:31:03] [INFO]  MySQL HeatWave DB System(s) scanned : 1
[2026-04-01 18:31:03] [INFO]   ├─ Already stopped : 0
[2026-04-01 18:31:03] [INFO]   ├─ In transition   : 0
[2026-04-01 18:31:03] [INFO]   └─ Stop by AutoStop : 1 → 1 successful
...
- `execution.post_check_delay_seconds`는 Oracle Base DB/ADB/MySQL HeatWave가 stop 완료까지 오래 걸릴 수 있다는 점을 고려해 운영 환경에 맞게 조정한다.
